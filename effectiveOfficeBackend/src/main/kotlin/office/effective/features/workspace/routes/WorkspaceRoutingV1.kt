...
fun Route.workspaceRoutingV1() {
    route("/api/v1/workspaces") {
        ...
        suspend fun getWorkspacesRequest(call: ApplicationCall, tag: String) {
        ...
        suspend fun getFreeWorkspacesRequest(
            call: ApplicationCall,
            tag: String,
            freeFromString: String?,
            freeUntilString: String?
        ) {
        ...
        get(SwaggerDocument.returnWorkspaceByTagV1()) {
            ...
            if (freeFromString == null && freeUntilString == null) {
                getWorkspacesRequest(call, tag)
            } else {
                getFreeWorkspacesRequest(call, tag, freeFromString, freeUntilString)
            }
        }
